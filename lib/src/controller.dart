...
class MeeduPlayerController {
  ...
  Widget? loadingWidget, header, bottomRight, customControls,bottomDrawer;
  ...
  /// [bottomDrawerController] instace of bottomdrawercontroller
  BottomDrawerController? get bottomDrawerController => _bottomDrawerController;
  ...
  MeeduPlayerController({
    ...
    this.bottomDrawer = bottomDrawer ?? Container();
  ...
  void onChangedSliderEnd() {
   ...
   void setBottomDrawer(Widget child) {
